        ...
        if (data.optBoolean("success", false)) {
            ...
            if (items != null && items.length() > 0) {
                ...
                if (duplicates.isNotEmpty()) {
                    ...
                    android.util.Log.i("ProductManagement", "✓ No duplicate product names found")
                }
                ...
                android.util.Log.d("ProductManagement", "After deduplication: ${uniqueItems.size} unique products")
